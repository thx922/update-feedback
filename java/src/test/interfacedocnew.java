...
/**
 * Created by ike on 16-9-27最新.
 */
@RestController
@RequestMapping("interfaceApiDoc")
public class interfacedocnew {
    ...
    public ModelAndView index(HttpServletRequest request ) {
        return new ModelAndView("interfaceApiDoc/interfaceDoc");
    }

    @GetMapping("findInterface")
    public ResponseText  findInterfaceApiDoc() {
    ...
    public List<Map<String, Object>> anno(String filePath, String classname) {
        ...
        try {
            ...
            for (String explain : readDocList) {
                ...
                String [] interfaceSplit = explain.split("ublic interface");
...
//        ClassPool pool = ClassPool.getDefault();
        ...
        if (codeAttribute != null) {
            ...
            System.out.println("福各位:"+cm.getParameterTypes().length);
