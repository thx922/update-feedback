...
/**
 * Created by ike on 16-9-14.  三级是 请求路径
 */
@RestController
@RequestMapping("interfaceApiDoc")
public class interfaceDocnew2 {
    ...
    public ModelAndView  findInterfaceApiDoc() {
        ...
        ResponseText text = new ResponseText(listActName);
//        return text;
                ...
                if (splits != null && splits.length >= 2) {
                    ...
                    if (splitMethods != null) {
                        ...
                        if (methodNames != null) {
                            ...
                            CtMethod  cm = cc.getDeclaredMethod(methodName, pool.get(paramTypeNames));
                            System.out.println("参数公分五:"+cm);*/
//                               cm.get
//                                map.put("annoParamType",parmType);
...
//                    System.out.println("方法返回类型:"+method.getReturnType().getName());
                String [] pkl =method.getReturnType().getName().split("\\.");
//                    System.out.println("方法师傅诶:"+pkl[pkl.length-1]);
...
//                    System.out.println("参数类型:"+parameterTypesAndName.substring(0, left));
        ...
        for(int i=0;i<listActName.size();i++){
            ...
            for( int j =0 ;j<classList.size();j++){
                ...
                if(map.get("demo") !="" && map.get("demo") !=null){
                    ...
                    for(int clsIndex =0 ;clsIndex<cruls.length; clsIndex++){
                        String cls = cruls[clsIndex];
...
//                            }
                            crulName = cls.substring(crulTypeIndex+2,cls.length()).replace("]","");
                            crulName = crulName.replace("http://localhost:8080","");
                            if( clsIndex < thirdIndex){
                                thirdIndex =thirdIndex+1;
                            }else{
                                thirdIndex = clsIndex+1;
                            }
                            sb.append("<div class='content' id='" + pckIndexInt + "-" + pckValueInt + "-" + thirdIndex + "'>")
                                    .append("<div class='main'>")
//                                    .append("<h4>方法<span>&gt;</span> japi使用指南" + pckIndexInt + "-" + pckValueInt + "-" + thirdIndex + " </h4>")
                                    .append("<h5>" + crulName + "</h5>")
                                    .append("<p class='explain'>使用说明 :</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+methodDes+"</p>")
                                    .append("<ul class='main_nav'>" +
                                            "<li><i></i><a href='javascript:;'>方法版本号 :&nbsp;&nbsp;&nbsp;"+methodVer+"</a></li>" +
                                            "<li><i></i><a href='javascript:;'>待续</a></li></ul>")
                                    .append("<div class='main_body'><i class='icon_d'></i><h6>接口例子</h6>" +
                                            "<div class='command'><span>type  :</span>" +
                                            "<div class='com_con'>"+crulType+"</div>" +
                                            "<span>crul  :</span>" +
                                            "&nbsp;&nbsp;&nbsp;http://localhost:8080"+crulName+"</div>")
                                    .append("<i class='icon_p'></i>")
                                    .append("<h6>参数</h6>");
                            ...
                            //三级菜单
                            liIndex.append("<li><a href='javascript:void(0)'  class='submenu'>" + crulName + "</a></li>");
                        }
                    }
                }
                /*else{
                    sb.append("<div class='content' id='" + pckIndexInt + "-" + pckValueInt + "-" + 1 + "'>")
                            .append("本页面无内容.....,期待继续关注!")
                            .append("</div>");
                    //三级菜单
                    liIndex.append("<li><a href='javascript:void(0)'  class='submenu'>无内容</a></li>");
                }*/
                ...
                while(iterator.hasNext()) {
                    ...
                    if (entry1.getKey().equals(map.get("packageName").toString())) {
                        strClassName  ="<div class='menu'> " +
                                ...
                                "<span>"+fileName+"</span><i class='iconfont'>&#xe608;</i></a>" +
                                "<ul class=' change'>";
//                        liIndex.append("<li><a href='javascript:void(0)'  class='submenu'>" + map.get("methodName") + "</a></li>");
        ...
        for (int i=0;i<pckNameIndexMap1.size();i++){
            ...
            String mainbavStr =" <div class='mainbav'><a href='javascript:void(0)' class='a_width mainbavClick ' title='"+pckDescIndexMap.get(guideIndexStr)+"' ><span>"+guideIndexStr+"</span><i class='iconfont'>&#xe608;</i></a>";
