...
public class InterfaceDoc {
    ...
    public List<Object>  findInterfaceApiDoc() {
...
//        String filePath = "/home/ike/java/java/japi/java/src/main/java/com/dounine/japi/web";
        ...
        classList = webActName(filePath, entityPrePath, names, null);
        return classList;
    }
    ...
    public List<Object>  webActName(String filePath, String entityPrePath, String[] names, String dir) {
        String filePathName = "";
        ...
        for (String s : names) {
            ...
            Class<?> demo1 = null;
            if(strings[0].equals("InterfaceDoc")){
                continue;
            }
...
//                returnMap.put("classList",classList);
        ...
        System.out.println("最后的:"+listReturn);
        return listReturn;
    }
