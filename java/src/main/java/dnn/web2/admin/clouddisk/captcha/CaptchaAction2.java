package dnn.web2.admin.clouddisk.captcha;
...
public class CaptchaAction2 {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CaptchaAction2.class);
	...
	public void readCaptcha(String account, OutputStream outputStream){
		LoginUserToken loginUserToken = ClouddiskAction2.LOGIN_USER_TOKEN;
