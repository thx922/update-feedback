package dnn.web1.admin.clouddisk.captcha;
...
public class CaptchaAction1 {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CaptchaAction1.class);
	...
	public void readCaptcha(String account, OutputStream outputStream){
		LoginUserToken loginUserToken = ClouddiskAction1.LOGIN_USER_TOKEN;
