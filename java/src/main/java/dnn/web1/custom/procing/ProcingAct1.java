package dnn.web1.custom.procing;
...
public class ProcingAct1 {
     ...
     * #return
     */
    @MethodVersionAnnotation(version = "1.7")
    public ModelAndView index(int a,int b,String f) {
        return new ModelAndView("custom/procing/index");
    }
    ...
    public ModelAndView index(int b ,String ht,int w) {
        return new ModelAndView("custom/procing/index");
    }

    /**
     * 我是1.0版本的index方法,没有神马用,若要使用index请使用上面1.4版本的吧gtu人头感觉偶热
     * #param request
     * #exclude  request ss
     * #include
     * #version 1.0
